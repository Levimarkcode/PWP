...
public class MiscellaneousInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_miscellaneous_input);

        // Initialize views using matching IDs
        amountEditText = findViewById(R.id.amount);
        noteEditText = findViewById(R.id.note);
        submitButton = findViewById(R.id.miscellaneous_btn);
