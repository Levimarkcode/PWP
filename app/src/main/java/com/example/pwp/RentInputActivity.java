...
public class RentInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent_input);

        // Initialize views using matching IDs
        amountEditText = findViewById(R.id.amount);
        noteEditText = findViewById(R.id.note);
        submitButton = findViewById(R.id.rent_btn);

        // Initialize Firebase Database Reference
        databaseReference = FirebaseDatabase.getInstance().getReference("Rent");
